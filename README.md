<div align="center">
  <img src="assets/profileGIF.gif" alt="Sebastian Tamayo-Vegas: from physical insight to validated systems" width="100%" />
...
![Frequency-dependent instrument response from the supplied acid-exposure CSV](assets/evidence/acid-exposure-rf-response.svg)
...
![Measured S21 magnitude for resonator and void configurations](assets/evidence/resonator-vs-void-s21.svg)
...
![Occupancy grid generated from the supplied motion-planning image](assets/evidence/matlab-occupancy-grid.png)
...
![Robotic-turtle system diagram based on supplied design material](assets/evidence/turtle-system.svg)
...
![Industrial delivery workflow from requirements to improvement](assets/evidence/industrial-delivery-flow.svg)
...
![Fuzzy-evaluation architecture from the supplied hybrid-education project](assets/evidence/fuzzy-evaluation-architecture.svg)
